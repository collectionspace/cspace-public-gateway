...
ENV ES_ALLOWEDPUBLISHTOVALUES=all \
    ...
    SERVER_PORT=8181 \
    ZUUL_ROUTES_CSPACE-SERVICES_PASSWORD=reader \
    ZUUL_ROUTES_CSPACE-SERVICES_SENSITIVEHEADERS=Cookie,Set-Cookie \
    ZUUL_ROUTES_CSPACE-SERVICES_URL=http://localhost:8180/cspace-services \
    ZUUL_ROUTES_CSPACE-SERVICES_USERNAME=reader@core.collectionspace.org \
